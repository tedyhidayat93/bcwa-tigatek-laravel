<div class="card">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">
            ...
            {{$method == 'put' ? 'Edit' : 'Create'}} Medizine Type
        </h6>
    </div>

    <div class="card-body">
            <form action="{{$method == 'post' ? route('cpanel.medizine.type.store') : route('cpanel.medizine.type.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-7 offset-md-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7 p-0">
                                ...
                                <img src="{{asset('uploads/post_types/thumb/'.$data->icon)}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 p-0 d-flex align-items-center justify-content-end">
                                <a href="{{route('cpanel.medizine.type.list')}}" class="btn btn-secondary mr-1">Cancel</a>

<div class="card">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">
            ...
            {{$method == 'put' ? 'Edit' : 'Create'}} Program
        </h6>
    </div>

    <div class="card-body">
        <form action="{{$method == 'post' ? route('cpanel.program.store') : route('cpanel.program.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-7 offset-md-1">
                    <div class="form-group row">
                        <label class="col-sm-5 col-form-label text-md-right pr-4" for="name">Program Name <small class="text-danger">(*)</small></label>
                        <input class="form-control text-sm col-sm-7" id="name" type="text" name="name"
                            placeholder="Input Program Name" value="{{$data->name}}" required>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7 p-0">
                            ...
                            <br>
                            <img src="{{asset('uploads/programs/icons/thumb/'.$data->icon)}}"
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-7 p-0">
                            ...
                            <br>
                            <img src="{{asset('uploads/programs/banners/thumb/'.$data->banner)}}"
                                class="img-fluid w-50 img-thumbnail mt-2">
                            @endif
                        </div>
                    </div> --}}
                    <div class="row">
                        ...
                        <div class="col-sm-7 p-0 d-flex align-items-center justify-content-end">
                            <a href="{{route('cpanel.program.list')}}" class="btn btn-secondary mr-1">Cancel</a>

<div class="card-header px-2">
    <div class="row">
        ...
        <div class="col-md-8 d-flex align-items-center justify-content-end">
            ...
            <a href="{{route('cpanel.information.create')}}" class="btn btn-success float-right"><i class="fas fa-fw fa-plus"></i>Add Information</a>
            @endcan
        </div>
    </div>
    ...
    <form method="GET">
        <div class="row">
            ...
            <div class="col-12 col-md form-group mb-0">
                ...
                @if(request()->query())
                <a href="{{route('cpanel.information.list')}}" class="text-xs text-danger ml-3">Reset Filter</a>
                @endif
            </div>
        </div>
    </form>

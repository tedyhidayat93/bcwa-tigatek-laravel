<div class="card mt-3">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">
            ...
            {{$method == 'put' ? 'Edit' : 'Add New'}} Mentor
        </h6>
    </div>

    <div class="card-body">
        <form action="{{$method == 'post' ? route('cpanel.mentor.store') : route('cpanel.mentor.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="px-md-3 col-md-7 offset-md-1">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7 p-0">
                            ...
                            <br>
                            <img src="{{asset('uploads/mentors/thumb/'.$data->avatar)}}"
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-sm-7 p-0 d-flex align-items-center justify-content-end">
                            <a href="{{route('cpanel.mentor.list')}}" class="btn btn-secondary mr-1">Cancel</a>

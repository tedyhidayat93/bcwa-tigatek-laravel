<div class="card mt-3">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">
            ...
            {{$method == 'put' ? 'Edit' : 'Tambah'}} FAQ
        </h6>
    </div>

    <div class="card-body">
        <form action="{{$method == 'post' ? route('cpanel.faq.store') : route('cpanel.faq.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
            {{$method == 'put' ? method_field('put') : ''}}
            <input class="form-control text-sm bg-light" id="id" type="hidden" name="id" value="{{$data->id}}" readonly>
            <div class="row">
                <div class="px-md-3 col-md-10">
                    <div class="form-group row">
                        <label class="col-sm-12 col-form-label px-0" for="ask">Pertanyaan <small class="text-danger">(*)</small></label>
                        <input class="form-control text-sm col-sm-12" id="ask" type="text" name="ask"
                            placeholder="Input Pertanyaan" value="{{old('ask', $data->ask)}}" required>
                    </div>
                </div>
            ...
            {{-- <div class="row">
                <div class="px-md-3 col-md-12">
                    <div class="form-group row">
                        ...
                        <textarea class="form-control text-sm col-sm-12" id="caption" type="text" rows="5" name="caption"
            ...
            <div class="row">
                <div class="px-md-3 col-md-12">
                    <div class="form-group row">
                        <label class="col-sm-12 col-form-label px-0" for="question">Jawaban</label>
                        <div class="col-12 p-0">
                            <textarea class="form-control text-sm col-sm-12 ckeditor5" style="height: 500px;" id="question" type="text" rows="5" name="question"
                                placeholder="Optional">{{old('question', $data->question)}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-12 p-0 d-flex align-items-center justify-content-center">
                    <a href="{{route('cpanel.faq.list')}}" class="btn btn-secondary mr-1">Batal</a>

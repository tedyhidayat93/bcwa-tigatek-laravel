    ...
    <div class="row">
        <div class="col-md-4 d-flex align-items-center justify-content-start w-100">
            <h4 class="mb-0 font-weight-bold ml-1">
                ...
                Paket Broadcast List
            </h4>
        </div>
        <div class="col-md-8 d-flex align-items-center justify-content-end">
            <a href="{{route('cpanel.package.create')}}" class="btn btn-success float-right"><i class="fas fa-fw fa-plus"></i>Buat Paket Broadcast Baru</a>
        </div>
    </div>
    ...
    <form method="GET">
        <div class="row">
            ...
            <div class="col-12 col-md form-group mb-0">
                ...
                @if(request()->query())
                <a href="{{route('cpanel.package.list')}}" class="text-xs text-danger ml-3">Reset Filter</a>
                @endif
            </div>
        </div>
    </form>
